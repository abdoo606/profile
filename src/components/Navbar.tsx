...
const Navbar = ({ onAdminClick }: NavbarProps) => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-slate-900/95 backdrop-blur-md shadow-lg' : 'bg-slate-900/50 backdrop-blur-sm'} border-b border-slate-800/50`}>
