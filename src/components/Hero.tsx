    ...
    <section id="home" className="min-h-screen flex items-center justify-center pt-20 bg-slate-950 text-white overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 z-10">
        <div className={`flex flex-col-reverse md:flex-row items-center gap-12 max-w-6xl mx-auto ${dir === 'rtl' ? 'md:flex-row-reverse' : ''}`}>
          ...
          >
            <h2 className="text-blue-400 font-mono mb-4 text-lg">{settings.heroGreeting || t('hero.greeting')}</h2>
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -bottom-2 -right-2 bg-gradient-to-r from-blue-600 to-emerald-600 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg">
                IT Engineer
              </div>
            </div>
          </motion.div>
